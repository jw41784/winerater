/**
 * WineRater App
 * A professional application for rating and tracking wine experiences
 */
...
const WineRater = {
    ...
    setupEventListeners: function() {
        ...
        // Wine card click for details (collection view)
        ...
        // Wine card click for details (dashboard view - top wines)
        ...
        // Wine card click for details (dashboard view - recent wines)
    ...
    filterCollection: function() {
        ...
        if (wines.length === 0 && this.data.wines.length === 0) {
            ...
            document.getElementById('empty-collection').innerHTML = `
                ...
                <p>Try adjusting your search or filters to find wines in your collection.</p>
    ...
    renderWineCards: function(wines, containerId) {
        ...
        for (const wine of wines) {
            ...
            const wineImage = wine.imageData ? 
                ...
                `<div class="wine-placeholder" style="height: 100%; display: flex; align-items: center; justify-content: center;"><i class="fas fa-wine-bottle" style="font-size: 3rem; color: rgba(255,255,255,0.3);"></i></div>`;
    ...
    openWineDetails: function(wineId) {
        ...
        const wineImage = wine.imageData ? 
            `<img src="${wine.imageData}" alt="${wine.name}">` : 
            `<div class="wine-placeholder" style="height: 100%; display: flex; align-items: center; justify-content: center; background-color: #f5f5f5;"><i class="fas fa-wine-bottle" style="font-size: 5rem; color: rgba(0,0,0,0.1);"></i></div>`;
